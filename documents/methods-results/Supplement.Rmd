...
Because a long term goal for Tetiaroa is to restore abandoned coconut plantation areas to native vegetation, the condition score of the land habitat will be based on the extent of coconut grove versus native habitat. We will also include altered habitat (ie landscaped) since much of the habitat on Onetahi has been altered for construction of the Brando. 
...
Frank does not feel that the land vegetation makeup has changed much over the past 5 years, therefore the trend for land habitats was zero. For coral reefs, we substituted the global trend score for French Polynesia.  
