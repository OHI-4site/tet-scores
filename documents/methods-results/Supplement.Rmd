...
*prepare to insert global methods for French Polynesia, since we have nothing*
...
### Habitat Services (HS)
The Habitat Services (HS) goal is made up of two subgoals, Carbon Storage (CS) and Coastal Protection (CP). Lacking specific data on carbon storage capabilities of the native habitat, this assessment only calculated a score for habitat proteciton. 
...
The Carbon Storage goal measures the health of carbon storing habitats. Highly productive coastal wetland ecosystems (e.g., mangroves, salt marshes, seagrass beds) have substantially larger areal carbon burial rates than terrestrial forets, and "Blue Carbon" has been suggested as an alternate, more manageable carbon sequestration approach. The rapid destruction of these coastal habitats may release large amounts of buried carbon back into the ocean-atmosphere system. Our focus here, therefore, is on coastal habitats because they are threatened, have large amounts of stored carbon that would rapidly be released with further habitat destruction, have the highest per-area sequestration rates of any habitat on the planet, and are amenable to management, conservation, and restoration efforts. We refer to this goal as carbon storage but intend its meaning to include sequestration.
